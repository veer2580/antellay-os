    ...
    <main class="flex-grow flex flex-col items-center justify-center relative z-30 px-6 py-12 min-h-screen w-full">
        ...
        <div class="mt-8 flex flex-col items-center gap-4 relative z-20">
            <div class="flex -space-x-2">
                <img src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=40&h=40&fit=crop&crop=face" alt="Active Node" class="w-10 h-10 rounded-full border border-slate-800 bg-black object-cover shadow-lg">
                <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=40&h=40&fit=crop&crop=face" alt="Active Node" class="w-10 h-10 rounded-full border border-slate-800 bg-black object-cover shadow-lg">
                <img src="https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=40&h=40&fit=crop&crop=face" alt="Active Node" class="w-10 h-10 rounded-full border border-slate-800 bg-black object-cover shadow-lg">
 ...
 *  size         — 0.05–200  stroke / particle scale (default: 1)
 *  density      — 0.25–2.5  path count multiplier (default: 1)
 *  opacity      — 0.05–1   overall opacity (default: 1)
 *  hue          — -180–180  hue-rotate degrees (default: 0)
 *  saturation   — 0–2   CSS saturate() (default: 1)
 *  brightness   — 0.35–1.65  CSS brightness() (default: 1)
 *  className    — additional CSS classes for the iframe wrapper
 *  style        — inline style for the iframe
 */
