  ...
  return (
    <div className="relative min-h-screen pt-28 pb-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
      ...
      <div className="text-center max-w-3xl mx-auto mb-12">
        <div className="inline-flex items-center gap-2 font-mono text-[10px] sm:text-xs tracking-[0.3em] text-cyan-400 uppercase font-semibold border border-cyan-500/30 px-3.5 py-1 rounded-full bg-cyan-950/50 mb-4 shadow-[0_0_20px_rgba(0,229,255,0.1)]">
      ...
      <div className="relative p-5 sm:p-7 rounded-2xl border border-cyan-500/40 bg-gradient-to-br from-[#040c24]/90 via-[#030718]/90 to-[#020510]/95 backdrop-blur-xl mb-10 shadow-[0_0_35px_rgba(0,229,255,0.08)]">
        ...
        <div className="flex items-start gap-4">
          <div className="w-9 h-9 rounded-xl bg-cyan-950/80 border border-cyan-500/40 flex items-center justify-center text-cyan-300 shrink-0 shadow-[0_0_15px_rgba(0,229,255,0.2)]">
            <Sparkles className="w-4 h-4" />
          </div>
          <div>
            <h2 className="font-display text-sm sm:text-base font-bold tracking-wider text-white uppercase mb-1.5">
      ...
      <div className="space-y-4 mb-10">
        {sections.map((section) => {
          ...
          return (
            <div
              key={section.id}
              className="p-5 sm:p-6 rounded-xl border border-cyan-500/20 bg-[#030716]/80 hover:border-cyan-400/50 hover:bg-[#040a1e]/90 transition-all duration-300 backdrop-blur-md group shadow-sm hover:shadow-[0_0_20px_rgba(0,229,255,0.08)]"
            >
              <div className="flex flex-col sm:flex-row items-start justify-between gap-3 mb-2.5">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-cyan-950/60 border border-cyan-500/30 flex items-center justify-center text-cyan-400 group-hover:border-cyan-400 group-hover:text-cyan-300 group-hover:shadow-[0_0_12px_rgba(0,229,255,0.3)] transition-all shrink-0">
                    <Icon className="w-4 h-4" />
                  </div>
                  <h3 className="font-display text-sm sm:text-base font-bold tracking-wider text-white group-hover:text-cyan-200 transition-colors">
                    {section.title}
                  </h3>
                </div>

                <span className="font-mono text-[10px] text-cyan-400/80 bg-cyan-950/50 border border-cyan-500/30 px-2 py-0.5 rounded tracking-widest shrink-0">
                  SECTION {section.id}
                </span>
              </div>

              <p className="font-sans text-xs sm:text-sm text-slate-300 leading-relaxed mb-2 pl-0 sm:pl-11">
                {section.content}
              </p>
      ...
      <div className="p-6 rounded-2xl border border-emerald-500/30 bg-[#021118]/80 backdrop-blur-md text-center max-w-3xl mx-auto shadow-[0_0_30px_rgba(16,185,129,0.08)]">
        ...
        <div className="mt-5 flex flex-wrap justify-center items-center gap-4">
          <Link
            to="/contact"
            className="inline-flex items-center gap-2 px-5 py-2 rounded-lg border border-cyan-500/40 bg-cyan-950/60 hover:bg-cyan-900/60 text-cyan-300 hover:text-white font-mono text-xs tracking-wider transition-all"
          >
